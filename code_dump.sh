...
#https://github.com/neomutt/sample-data/blob/main/fruit.txt
https://www.kaggle.com/datasets/daichiuchigashima/thelook-ecommerce?select=thelook_ecommerce.products.csv
